  ...
  */
  ...
  static upVector(pos) {
    ...
    if (pos.u > 0.1)
      ...
      //return moy2([-vFinal[0], -vFinal[1], -vFinal[2]], vFinal, pos.v / 0.1);//a bit a hack
      const innerVector = pos.outside ? [0, 0, -4] : [0, 0, 4];
      return moy3([-vFinal[0], -vFinal[1], -vFinal[2]], innerVector, vFinal, pos.u / 0.1);//a bit a hack
